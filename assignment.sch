...
C {vsource.sym} -50 20 0 0 {name=Vin value=0 savecurrent=false}
...
C {code_shown.sym} 240 -190 0 0 {name=s1 only_toplevel=false value="
.option wnflag=0
.option savecurrents
.control
save all
